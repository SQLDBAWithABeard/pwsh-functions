...
param keyVaultResourceGroup string = 'beard-key-vault'
...
resource storageaccount 'Microsoft.Storage/storageaccounts@2021-02-01' = {
  name: 'sa${uniqueResourceNameBase}'
  sku: {
    name: 'Standard_LRS'
  }
  kind: 'StorageV2'
...
module keyvault 'keyvault.bicep' = {
  ...
  params: {
    ...
    storageSecValue: 'DefaultEndpointsProtocol=https;AccountName=${storageaccount.name};AccountKey=${listKeys(storageaccount.id,storageaccount.apiVersion).keys[1].value}'
  }
}

// resource keyvault1 'Microsoft.KeyVault/vaults@2019-09-01' = {
//   name: 'keyvault-${uniqueResourceNameBase}'
//   dependsOn: [
//    
//   ]
//   location: location
...
resource appplan 'Microsoft.Web/serverfarms@2020-12-01' = {
  name: 'appplan-${uniqueResourceNameBase}'
  dependsOn: [
    storageaccount
  ]
  kind: 'functionapp'
...
resource functionapp 'Microsoft.Web/sites@2022-03-01' = {
  name: 'functionapp-${uniqueResourceNameBase}'
  dependsOn: [
    storageaccount
  ...
  resource functionSettings 'config' = {
    ...
    properties: {
      ...
      SA_CONNECTION_STRING: '@Microsoft.KeyVault(SecretUri=https://${keyVaultName}.vault.azure.net/secrets/${keyvault.outputs.StorageSecretName}/)'
      Bright_Meter_Password:'@Microsoft.KeyVault(VaultName=${keyVaultName};SecretName=bright-password)'
      Home_Energy_Database_Password:'@Microsoft.KeyVault(VaultName=${keyVaultName};SecretName=homeenergy-load)'
      TOKEN: '@Microsoft.KeyVault(SecretUri=https://${keyVaultName}.vault.azure.net/secrets/tttoken/)'
      CHANNEL: '@Microsoft.KeyVault(SecretUri=https://${keyVaultName}.vault.azure.net/secrets/ttchannel/)'
      GITHUB_API_TOKEN: '@Microsoft.KeyVault(SecretUri=https://${keyVaultName}.vault.azure.net/secrets/githubapitoken/)'
...
resource appinsights 'Microsoft.Insights/components@2020-02-02-preview' = {
  name: 'appinsights-${uniqueResourceNameBase}'
  dependsOn: [
    storageaccount
  ]
  location: location
...
resource storageAccountReadPermission 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  name: guid(projectName, 'storageAccountReadPermission', uniqueResourceNameBase, subscription().subscriptionId)
  dependsOn: [
  ]
...
resource containerPermission 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  name: guid(projectName, uniqueResourceNameBase, subscription().subscriptionId)
  dependsOn: [
    storageaccount
  ]
  scope: container
